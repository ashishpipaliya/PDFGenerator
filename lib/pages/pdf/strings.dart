...
// page 2
  ...
  String email_address = "E-mail address if any";
  String nameAndRelationship =
      "Name of the patient & relationship with the card holder";
  String status2 = "Status";
  String basicPay = "1Basic Pay/Basic Pension";
  String hospitalname = "1Name of the Hospital with Address";
  String admitAndDischargeDate = "1Date of admission and  discharge";
  String totalAmountClaimed = "1Total amount Claimed";
  String referralDetails = "1Details of Referral";
  String medicalAdvance = "1Details of Medical advance if, any";
}
...
List<String> entitlementList = ["Private", "Semi Private", "General"];
List<String> statusList = ["Government Servant", "Member of Parliament"];
